          ...
          <div className="flex items-center space-x-3">
            <div className="relative hidden md:block">
              <Input
                type="text"
                placeholder="Buscar..."
                className="pl-9 pr-3 w-56 text-[13px] tracking-tight text-graphite-700 bg-blue-50/60 dark:bg-graphite-900 dark:text-graphite-100"
              />
              <MagnifyingGlassIcon
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-72 rounded-md border border-blue-100 bg-white shadow-sm opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all dark:border-graphite-700 dark:bg-graphite-900">
                <div className="px-3 py-2 text-xs font-medium text-graphite-500 border-b border-blue-100 dark:text-graphite-300 dark:border-graphite-700">
                  Notificações
                </div>
            ...
            <div className="flex items-center space-x-2.5 pl-3 border-l border-blue-100 dark:border-graphite-700">
              ...
              <div className="w-8 h-8 bg-blue-700 rounded-full flex items-center justify-center dark:bg-graphite-200">
